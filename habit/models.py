...
class Habit(models.Model):
    ...
    place = models.CharField(
        max_length=255, help_text="Место, в котором необходимо выполнять привычку."
    )
    ...
    action = models.CharField(
        max_length=255, help_text="Действие, которое представляет из себя привычку."
    )
    ...
    reward = models.CharField(
        max_length=255, blank=True, help_text="Вознаграждение за выполнение привычки."
    )
